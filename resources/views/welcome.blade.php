...
<body>
    ...
    <section class="landing">
        ...
        <div class="kanan">
            <img src="./kanan.png" style="width: 330px;">
        </div>
        <div class="kiri">
            <img src="./kiri.png" style="width: 390px;">
        </div>
    </section>
    ...
    <section class="prizes">
        ...
        <div class="topthree">
            <div class="cup">
                <div class="silver">
                    <img src="./silver cup.png" style="width: 350px; height: 334px;">
                    <div class="box">
                        <h4>2nd Place</h4>
                        <h5>Rp2.250.000</h5>
                        <p>+Merchandise</p>
                ...
                <div class="gold">
                    <img src="./golden cup.png" style="width: 400px; height: 382px;">
                    <div class="box">
                        <h4>1st Place</h4>
                        <h5>Rp4.000.000</h5>
                        <p>+Merchandise</p>
                ...
                <div class="bronze">
                    <img src="./bronze cup.png" style="width: 310px; height: 296px;">
                    <div class="box">
                        <h4>3rd Place</h4>
                        <h5>Rp1.500.000</h5>
                        <p>+Merchandise</p>
        ...
        <div class="judge">
            <div class="mentor_box">
                <div class="mentor_foto">
                    <img src="./dapid.png" style="width: 286px;">
                </div>
                <div class="tulisan">
                    <h3>David Brendi</h3>
                    <div class="utube">
                        <p>Youtuber at </p>
                        <img src="./gadgetin.png" style="width: 60px; height: 15px;">
                    </div>
                </div>
            </div>
            <div class="mentor_box">
    ...
    <section class="about">
        <div class="kiri">
            <img src="./kiri.png" style="width: 330px;">
        </div>
        <h2>About Hackathon</h2>
        <div class="kanan">
            <img src="./kanan.png" style="width: 390px;">
        </div>
    ...
    <section class="why">
        ...
        <div class="cardsection">
            <div class="card">
                <img src="./icon kolaborasi.png" style="width: 183px;">
                <h2>Kolaborasi</h2>
            ...
            <div class="card">
                <img src="./icon carrerdev.png" style="width: 115px;">
        ...
        <div class="cardsection2">
            <div class="card">
                <img src="./icon seru.png" style="width: 141px;">
                <h2>Seru</h2>
            ...
            <div class="card">
                <img src="./icon belajar.png" style="width: 126px;">
                <h2>Belajar</h2>
            ...
            <div class="rowbox">
                <a href="#">
                    <div class="qnabox">
                        ...
                        <img src="./ic_baseline-add-circle-outline.png" style="width: 20px;">
                    </div>
                </a>
            </div>
            <div class="rowbox">
    ...
    <section class="timeline">
        ...
        <div class="timelinebox">
            <div class="tbox">
                <div class="img">
                    <img src="./opreg.png" style="width: 100px;">
                </div>
            </div>
            <div class="tbox">
                <div class="img">
                    <img src="./closereg.png" style="width: 100px;">
                </div>
            </div>
            <div class="tbox">
                <div class="img">
                    <img src="./tm.png" style="width: 100px;">
                </div>
            </div>
            <div class="tbox">
                <div class="img">
                    <img src="./compeday.png" style="width: 100px;">
                </div>
            </div>
        </div>
        <div class="ttext">
        ...
        <div class="zoom">
            <img src="./location.png" style="width: 14px; height: 18px;">
            <p>Zoom Meeting</p>
        </div>
        <div class="zoom1">
            <img src="./location.png" style="width: 14px; height: 18px;">
    ...
    <section class="sponsor">
        ...
        <div class="content">
            <div class="platinum">
                <h3>Platinum</h3>
                <br/>
                <img src="./logo apple.svg" style="width: 170px;">
            </div>
            <div class="skiri">
                <img src="./kiri.png" style="width: 360px;">
            </div>
            <div class="sgold">
                <h3>Gold</h3>
                <br/>
                <div class="gambar">
                    <img src="./logo intel.svg" style="width: 180px;">
                    <img class="google" src="./logo google.svg" style="width: 230px;">
                </div>
            </div>
            <div class="skanan">
                <img src="./kanan.png" style="width: 360px;">
            </div>
            <div class="ssilver">
                <h3>Silver</h3>
                <br/>
                <div class="gambar">
                    <img src="./logo hewlettpackard.svg" style="width: 50px;">
                    <img src="./logo blackrock.svg" style="width: 270px;">
                    <img src="./logos_microsoft.svg" style="width: 170px;">
                </div>
            </div>
        </div>
    ...
    <section class="media_partner">
        ...
        <div class="medparcontent">
            <div class="medparline1">
                <img src="./bbc.svg" style="width: 100px;">
                <img src="./fox.svg" style="width: 70px;">
                <img src="./net.svg" style="width: 75px;">
                <img src="./nyt.svg" style="width: 34px;">
                <img src="./transmedia.svg" style="width: 225px;">
                <img src="./Prambors.svg" style="width: 45px;">
            </div>
            <div class="medparline2">
                <img src="./binustv.png" style="width: 90px;">
                <img src="./Kompas.svg" style="width: 130px;">
                <img src="./Liputan6.svg" style="width: 205px;">
                <img src="./cnn.svg" style="width: 64px;">
                <img src="./natgeo.svg" style="width: 25px;">
            </div>
            <div class="medparline3">
                <img src="./cnbc.svg" style="width: 40px;">
                <img src="./detikcom.png" style="width: 130px; height: 27px;">
                <img src="./folkative.png" style="width: 130px;">
                <img src="./filemagz.png" style="width: 121px;">
                <img src="./idntimes.png" style="width: 135px;">
            </div>
        </div>
    </section>
    <section class="other">
        ...
        <div class="ocontent">
            <div class="obox">
                <img src="./vircon bg.jpg" width="487px;" height="500px;">
            ...
            <div class="obox">
                <img src="./workshop bg.jpg" width="487px;" height="500px;">
    ...
    <section class="footer">
        ...
        <div id="footerbawah">
            <div class="bagianatas">
                <img src="./logo technoscape.svg" style="width: 212px;">
            </div>
            <div class="bagianbawah">
                <div class="bagiankanan">
                    <div class="power">
                        <p>Powered by</p>
                        <img src="./bncclogo - Edited.png" style="width: 110px;">
                    </div>
                    <div class="sponsored">
                        <p>Sponsored by</p>
                        <div class="atas">
                            <img src="./logo intel.svg" style="width: 51px;">
                            <img src="./logos_microsoft.svg" style="width: 75px;">
                        </div>
                        <div class="bawah">
                            <img src="./logo hewlettpackard.svg" style="width: 20px;">
                            <img src="./logo apple.svg" style="width: 18px;">
                            <img src="./logo google.svg" style="width: 75px;">
                        </div>
                    </div>
                    <div class="medpar">
                        <p>Media Partner</p>
                        <div class="atas">
                            <img src="./bbc.svg" style="width: 42px;">
                            <img src="./fox.svg" style="width: 28px;">
                            <img src="./net.svg" style="width: 29px;">
                            <img src="./nyt.svg" style="width: 12px;">
                            <img src="./transmedia.svg" style="width: 99px;">
                            <img src="./Prambors.svg" style="width: 14px;">
                        </div>
                        <div class="tengah">
                            <img src="./Liputan6.svg" style="width: 83px;">
                            <img src="./binustv.png" style="width: 43px;">
                            <img src="./Kompas.svg" style="width: 64px;">
                            <img src="./cnn.svg" style="width: 28px;">
                            <img src="./natgeo.svg" style="width: 11px;">
                        </div>
                        <div class="bawah">
                            <img src="./cnbc.svg" style="width: 17px;">
                            <img src="./detikcom.png" style="width: 64px;">
                            <img src="./folkative.png" style="width: 57px;">
                            <img src="./idntimes.png" style="width: 72px;">
                            <img src="./filemagz.png" style="width: 46px;">
                        </div>
                    </div>
                </div>
