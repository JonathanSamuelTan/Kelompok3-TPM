...
<body>
    <section id="contact-form">
        <div class="information-group">
            ...
            <form  action="store-leader" method="POST" enctype="multipart/form-data" class="form" onsubmit="return Check()">
                @csrf
                <div class="tab">
                    <div class="input-group">
                        <label for="Nama-leader">Nama Leader</label>
                        <input type="text" name="leaderName" id="Nama-leader" placeholder="Tuliskan nama kamu!">
                    </div>
                    <div class="input-group">
                        <label for="Email">Email</label>
                        <input type="email" name="leaderEmail" id="Email" placeholder="Tuliskan email kamu! (Cth: contoh@domain.com)" oninput="CheckEmail()">
                        <div class="symbol">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="leaderWA" id="NoWhatsapp" placeholder="Tuliskan nomor Whatsapp-mu! (Cth: 08xxxxxxxx)" oninput="CheckNumber()">
                    ...
                    <div class="dua">
                        <div class="bagi-dua">
                            ...
                            <input type="text" name="leaderLine" id="ID-Line" placeholder="Tuliskan ID LINE kamu!">
                        </div>
                        <div class="bagi-dua">
                            <label for="ID-Github">ID Github</label>
                            <input type="text" name="leaderGithub" id="ID-Github" placeholder="Tuliskan ID Github kamu!">
                        </div>
                    </div>
                    <div class="next">
                ...
                <div class="tab">
                    ...
                    <div class="dua">
                        <div class="bagi-dua">
                            ...
                            <div class="drag-drop">
                                <iconify-icon icon="icon-park-outline:add-picture" height="25px" width="25px"></iconify-icon>
                                <input type="file" class="dropzone-input" id="Curriculum-Vitae" name="leaderCV"hidden>
                                <h2>Drag and Drop file to upload</h2>
                                <p class="CV-1">(Format File: PDF, JPG, JPEG, PNG)</p>
                                <p class="OR">Or</p> 
                                <button type="button" for="Curriculum-Vitae" class="browse" id="cv">Browse</button>
                            </div>
                        </div>
                        <div class="bagi-dua CV">
                            ...
                            <div class="drag-drop1">
                                ...
                                <p class="CV-1">(Format File: PDF, JPG, JPEG, PNG)</p>
                                <p class="OR">Or</p>
                                <input type="file" class="dropzone-input1" id="Flazz/ID" name="leaderFlazz" hidden>
                                <button type="button" for="Flazz/ID" class="browse" id="IDCard">Browse</button>
                            </div>
                        </div>
                    </div>
                    <div class="next">
